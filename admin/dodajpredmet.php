<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $qInsert = $conn->prepare("INSERT INTO predmet(ime_predmeta, boja) VALUES (:naziv, :boja)");
            $qInsert->bindParam(":naziv", $naziv_predmeta);
            $qInsert->bindParam(":boja",$boja);
            $qInsert->execute();            
            ...
            <main class="col-md-10 content">
                ...
                <form action="" method="post">
                    <div class="mt-3">
                        ...
                        <input type="text" name="naziv_predmeta" id="naziv_predmeta" class="form-control" placeholder="Naziv" required>
                    </div>
                    <div class="mt-3">
